...
# spring-boot-properties-quickstart Project
...
You can then execute your native executable with: `./target/spring-boot-properties-quickstart-1.0.0-SNAPSHOT-runner`
